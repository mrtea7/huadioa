privilege
    ...
    .controller("RoleManageCtrl", ["$scope", 'requestService', 'roleEntityService',
        function ($scope, requestService, roleEntityService) {
    ...
    .directive("myRoleEntity", ["roleEntityService",
